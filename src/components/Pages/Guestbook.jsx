            ...
            return (
                <>
                    ...
                    <button
                        ...
                        className="mt-1 self-start px-5 py-2 rounded-xl bg-white text-black font-bold text-base flex items-center gap-2 hover:bg-white/80 transition-colors duration-200"
                    >
            ...
            return (
                <>
                    ...
                    <input
                        ...
                        className="bg-transparent border-b border-white/30 text-white text-sm font-mono outline-none placeholder:text-white/40 py-1"
                    />
                    <div className="flex items-center gap-3 mt-1">
                        ...
                        <button
                            onClick={signOut}
                            className="px-4 py-1 rounded-xl bg-white text-black font-bold text-xs hover:bg-white/80 transition-colors duration-200"
                        >
                            Sign Out
                        </button>
                    </div>
